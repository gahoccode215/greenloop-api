...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeProducts() {
        ...
        createProductWithImages("AT001", "Áo Thun Trắng Basic Unisex",
                "Áo thun cotton 100%, form regular fit, cổ tròn, màu trắng tinh. Chất liệu thoáng mát, thấm hút mồ hôi tốt.",
        ...
        createProductWithImages("AT002", "Áo Thun Đen Oversize Streetwear",
                "Áo thun cotton form rộng, màu đen, phong cách streetwear. Thiết kế oversize trendy.",
        ...
        createProductWithImages("AT004", "Áo Thun Xám Melange V-Neck",
                "Áo thun cổ V, màu xám melange, chất liệu cotton pha spandex co giãn nhẹ.",
        ...
        createProductWithImages("AT005", "Áo Thun Graphic NYC Vintage",
                "Áo thun in chữ NYC vintage, màu be, phong cách retro. Chất cotton mềm mại.",
        ...
        createProductWithImages("AT006", "Áo Thun Hồng Pastel Nữ",
                "Áo thun nữ màu hồng pastel nhẹ nhàng, form fitted ôm dáng. Cotton co giãn.",
        ...
        createProductWithImages("AT007", "Áo Thun Sọc Ngang Navy White",
                "Áo thun sọc ngang màu navy trắng, phong cách nautical. Chất cotton mịn.",
        ...
        createProductWithImages("AT008", "Áo Polo Đỏ Đô Sang Trọng",
                "Áo polo màu đỏ đô, chất liệu pique cotton cao cấp. Phù hợp đi làm.",
                aoThun, new BigDecimal("90000"), 20, ConditionGrade.LIKE_NEW,
                ProductStatus.AVAILABLE, ProductType.RESALE, 230, 32, 42, 1,
                List.of(
                        "https://images.unsplash.com/photo-1628015321067-7e592e235ca8",
        ...
        createProductWithImages("AT009", "Áo Thun Xanh Lá Mint Fresh",
                ...
                List.of(
                        "https://images.unsplash.com/photo-1503341733017-1901578f9f1e",
                        "https://images.unsplash.com/photo-1525507119028-ed4c629a60a3"
                ));

        createProductWithImages("AT010", "Áo Thun Cam Neon Statement",
                "Áo thun màu cam neon nổi bật, form oversize. Thích hợp hoạt động ngoài trời.",
        ...
        createProductWithImages("QJ001", "Quần Jean Xanh Đậm Slim Fit Nam",
                "Quần jean dáng ôm slim fit, màu xanh đậm classic. Chất jean cotton co giãn nhẹ.",
        ...
        createProductWithImages("QJ003", "Quần Jean Rách Xanh Nhạt Distressed",
                ...
                List.of(
                        ...
                        "https://images.unsplash.com/photo-1542574621-e088a4464f7e"
                ));

        createProductWithImages("QJ004", "Quần Jean Skinny Xám Nữ",
                "Quần jean skinny ôm sát màu xám, form dáng đẹp tôn dáng. Co giãn 4 chiều.",
        ...
        createProductWithImages("QJ006", "Quần Jean Boyfriend Xanh Nhạt",
                "Quần jean boyfriend fit xanh nhạt, form rộng thoải mái. Phong cách casual.",
                ...
                List.of(
                        ...
                        "https://images.unsplash.com/photo-1548883354-5e29e98f20a5"
                ));
        ...
        createProductWithImages("QJ007", "Quần Jean Đen Rách Gấu Punk",
                ...
                List.of(
                        ...
                        "https://images.unsplash.com/photo-1514311548104-e6314c8d869f"
                ));

        createProductWithImages("QJ008", "Quần Jean Xanh Đen Straight Fit",
                "Quần jean ống đứng màu xanh đen, form straight fit cổ điển.",
        ...
        createProductWithImages("QJ010", "Quần Jean Xanh Đậm Bootcut Retro",
                "Quần jean ống loe bootcut màu xanh đậm, phong cách retro 70s.",
                ...
                List.of(
                        ...
                        "https://images.unsplash.com/photo-1511105043137-c7fb5c3d02ee"
                ));
        ...
        createProductWithImages("AK002", "Áo Khoác Denim Xanh Vintage",
                ...
                List.of(
                        ...
                        "https://images.unsplash.com/photo-1523205771785-8a374895ddde"
                ));

        createProductWithImages("AK003", "Áo Bomber Đen Streetwear",
                "Áo khoác bomber màu đen, phong cách streetwear. Chất polyester nhẹ, chống gió.",
                ...
                List.of(
                        ...
                        "https://images.unsplash.com/photo-1515664069058-7dc02e70dbc8"
                ));
        ...
        createProductWithImages("AK005", "Áo Khoác Gió Xanh Navy",
                ...
                List.of(
                        "https://images.unsplash.com/photo-1544441892-794166f1e3be",
        ...
        createProductWithImages("AK007", "Áo Hoodie Zip Xanh Lá",
                ...
                List.of(
                        "https://images.unsplash.com/photo-1620799139834-6b8f844fbe29",
                        "https://images.unsplash.com/photo-1612681621975-539f4bdd5df9"
                ));
        ...
        createProductWithImages("AK008", "Áo Khoác Nỉ Bomber Cam",
                ...
                List.of(
                        "https://images.unsplash.com/photo-1608228088098-f5a2b6ce2fc9",
        ...
        createProductWithImages("AK009", "Áo Khoác Parka Xanh Rêu",
                ...
                List.of(
                        ...
                        "https://images.unsplash.com/photo-1485145782098-4f5fd605a66b"
                ));
        ...
        createProductWithImages("DV001", "Váy Maxi Hoa Nhí Pastel",
                "Váy dài maxi họa tiết hoa nhí màu pastel. Chất vải voan mỏng nhẹ.",
        ...
        createProductWithImages("DV003", "Váy Jean Ngắn Xanh Nhạt",
                "Váy jean xanh nhạt dáng ngắn, phong cách trẻ trung. Chất jean mềm.",
                ...
                List.of(
                        ...
                        "https://images.unsplash.com/photo-1508919801845-fc2ae1bc2a28"
                ));

        createProductWithImages("DV004", "Đầm Xòe Đen Dự Tiệc",
                "Đầm xòe màu đen, cổ tròn, tay ngắn. Thích hợp dự tiệc, sự kiện.",
        ...
        createProductWithImages("DV005", "Váy Midi Kẻ Sọc Navy",
                "Váy midi kẻ sọc ngang màu navy trắng, dáng chữ A. Phong cách nautical.",
        ...
        createProductWithImages("DV006", "Đầm Babydoll Hồng Pastel",
                "Đầm babydoll màu hồng pastel, dáng xòe nhẹ nhàng. Phong cách ngọt ngào.",
        ...
        createProductWithImages("DV008", "Đầm Maxi Đỏ Dự Tiệc",
                "Đầm maxi màu đỏ dài chạm sàn, vai bẹt quyến rũ. Thích hợp dự tiệc cưới.",
        ...
        createProductWithImages("DV009", "Váy Hoa Vintage Boho Style",
                "Váy hoa vintage phong cách boho, màu sắc tươi sáng. Chất vải cotton.",
        ...
        createProductWithImages("DV010", "Đầm Suông Xanh Mint Mùa Hè",
                "Đầm suông màu xanh mint tươi mát, tay ngắn. Chất vải linen mềm mại.",
                damVay, new BigDecimal("140000"), 26, ConditionGrade.LIKE_NEW,
                ProductStatus.AVAILABLE, ProductType.RESALE, 275, 38, 47, 2,
                List.of(
                        "https://images.unsplash.com/photo-1558769132-cb1aea37f766",
        ...
        createProductWithImages("SM002", "Áo Sơ Mi Xanh Navy Dáng Slim",
                "Áo sơ mi xanh navy dáng slim fit ôm body. Thiết kế thanh lịch.",
                aoSoMi, new BigDecimal("120000"), 24, ConditionGrade.GOOD,
                ProductStatus.AVAILABLE, ProductType.RESALE, 250, 35, 45, 1,
                List.of(
                        "https://images.unsplash.com/photo-1620012253295-c15cc3e65df4",
                        "https://images.unsplash.com/photo-1621951753014-0c5086d31d9c"
                ));

        createProductWithImages("SM003", "Áo Sơ Mi Flannel Kẻ Sọc Đỏ",
                "Áo sơ mi flannel kẻ sọc đỏ đen, phong cách lumberjack. Chất flannel ấm.",
        ...
        createProductWithImages("SM004", "Áo Sơ Mi Hồng Nữ Công Sở",
                ...
                List.of(
                        "https://images.unsplash.com/photo-1598032895397-b9372f6ddfe6",
                        "https://images.unsplash.com/photo-1583495491263-f3e371ff3e41"
                ));

        createProductWithImages("SM005", "Áo Sơ Mi Jean Xanh Nhạt",
                "Áo sơ mi jean màu xanh nhạt, phong cách casual. Chất denim mềm.",
                aoSoMi, new BigDecimal("130000"), 26, ConditionGrade.GOOD,
                ProductStatus.AVAILABLE, ProductType.RESALE, 290, 36, 46, 1,
                List.of(
                        "https://images.unsplash.com/photo-1594938328870-f9d0c0a5e86f",
                        "https://images.unsplash.com/photo-1602810316498-ab67cf68c8e1"
                ));

        createProductWithImages("SM006", "Áo Sơ Mi Lụa Đen Sang Trọng",
                "Áo sơ mi lụa màu đen, bóng mượt sang trọng. Phù hợp dự tiệc.",
        ...
        createProductWithImages("SM007", "Áo Sơ Mi Flannel Xanh Kẻ",
                "Áo sơ mi flannel kẻ xanh xám, phong cách outdoor. Chất flannel dày.",
        ...
        createProductWithImages("SM008", "Áo Sơ Mi Xanh Mint Nữ",
                "Áo sơ mi nữ màu xanh mint tươi mát, tay ngắn. Phong cách trẻ trung.",
        ...
        createProductWithImages("SM009", "Áo Sơ Mi Kaki Be Túi Hộp",
                "Áo sơ mi kaki màu be, có túi hộp hai bên ngực. Phong cách military.",
        ...
        createProductWithImages("SM010", "Áo Sơ Mi Hoa Văn Hawaii",
                "Áo sơ mi hoa văn Hawaii tay ngắn, màu sắc tươi sáng. Phong cách resort.",
        ...
        log.info("Created 60 products successfully!");
    }
