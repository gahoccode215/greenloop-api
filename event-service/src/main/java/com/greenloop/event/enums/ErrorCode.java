...
public enum ErrorCode {
    ...
    STAFF_EVENT_TIME_CONFLICT(
            "2003", "Staff Has a Time Conflict with Another Assigned Event", HttpStatus.BAD_REQUEST),
    ...
    EVENT_NOT_STARTED("4000", "Event Has Not Started Yet", HttpStatus.BAD_REQUEST);
