...
public enum ErrorCode {
    CONVERT_GOOGLE_PLACE_ERROR("1000", "Chuyển đổi dữ liệu Google Place thất bại", HttpStatus.BAD_REQUEST),
    ...
    EVENT_STATUS_UPDATE_ERROR("1008", "Lỗi cập nhật trạng thái sự kiện", HttpStatus.INTERNAL_SERVER_ERROR),
    EVENT_IMAGE_UPLOAD_ERROR("1009", "Lỗi tải lên hình ảnh sự kiện", HttpStatus.INTERNAL_SERVER_ERROR),
    EVENT_IMAGE_DELETION_ERROR("1010", "Lỗi xóa hình ảnh sự kiện", HttpStatus.INTERNAL_SERVER_ERROR),
    EVENT_LOCATION_UPDATE_ERROR("1011", "Lỗi cập nhật địa điểm sự kiện", HttpStatus.INTERNAL_SERVER_ERROR),
    EVENT_START_TIME_PAST("1012", "Thời gian bắt đầu sự kiện không được ở quá khứ", HttpStatus.BAD_REQUEST),
    EVENT_END_TIME_PAST("1013", "Thời gian kết thúc sự kiện không được ở quá khứ", HttpStatus.BAD_REQUEST),
    EVENT_END_TIME_BEFORE_START("1014", "Thời gian kết thúc không thể trước thời gian bắt đầu", HttpStatus.BAD_REQUEST),
    ...
    STAFF_ALREADY_ASSIGNED("2000", "Nhân viên đã được phân công cho sự kiện này", HttpStatus.BAD_REQUEST),
    STORE_MANAGER_ALREADY_ASSIGNED("2001", "Quản lý cửa hàng đã được phân công cho sự kiện này", HttpStatus.BAD_REQUEST),
    INVALID_ROLE("2002", "Vai trò phân công không hợp lệ", HttpStatus.BAD_REQUEST),
    STAFF_EVENT_TIME_CONFLICT("2003", "Nhân viên có xung đột thời gian với một sự kiện khác", HttpStatus.BAD_REQUEST),
    ...
    FAILED_TO_CALL_USER_SERVICE("3004", "Gọi tới User Service thất bại", HttpStatus.SERVICE_UNAVAILABLE),
