...
public class DashboardController {
    ...
    @GetMapping("/events")
    @Operation(summary = "Get event statistics", description = "Retrieves various statistics related to events.")
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_MANAGER')")
    @Operation(summary = "Get event registration statistics", description = "Retrieves various statistics related to event registrations.")
    public ResponseEntity<ApiResponseDTO<EventRegistrationStatisticsResponse>> getEventRegistrationStatistics() {
    ...
    @GetMapping("/staff")
    @PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_MANAGER')")
    @Operation(summary = "Get event staff statistics", description = "Retrieves various statistics related to event staff.")
