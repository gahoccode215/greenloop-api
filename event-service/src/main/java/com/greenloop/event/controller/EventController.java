...
public class EventController {
    ...
    @Hidden
    @GetMapping("/api/events/{eventId}/staff/{staffId}/validate")
    public ResponseEntity<Boolean> validateStaffInEvent(@PathVariable Long eventId, @PathVariable Long staffId, @RequestHeader(value = "API_SECRET_HEADER", required = false) String apiSecret) {
