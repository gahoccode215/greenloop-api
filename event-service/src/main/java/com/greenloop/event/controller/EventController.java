...
public class EventController {
  ...
  public void exportEvents(
    ...
    try {
      List<EventExportDTO> exportData =
          eventService.getExportData(
              eventId,
              status,
              month,
              year,
      ...
      try (Workbook workbook = ExcelExportUtil.createWorkbook()) {
        ...
        for (EventExportDTO dto : exportData) {
          ...
          row.createCell(colNum++)
              .setCellValue(dto.getEventCode() != null ? dto.getEventCode() : "");
          row.createCell(colNum++)
              .setCellValue(dto.getEventName() != null ? dto.getEventName() : "");
          row.createCell(colNum++).setCellValue(dto.getStatus() != null ? dto.getStatus() : "");
          row.createCell(colNum++)
              .setCellValue(dto.getStartTime() != null ? dto.getStartTime() : "");
          row.createCell(colNum++).setCellValue(dto.getEndTime() != null ? dto.getEndTime() : "");
          row.createCell(colNum++)
              .setCellValue(dto.getParticipantsCount() != null ? dto.getParticipantsCount() : "");
          row.createCell(colNum++)
              .setCellValue(dto.getStaffCount() != null ? dto.getStaffCount() : "");
          row.createCell(colNum++)
              .setCellValue(dto.getCheckinCount() != null ? dto.getCheckinCount() : "");
          ...
          row.createCell(colNum++)
              .setCellValue(dto.getCheckinTime() != null ? dto.getCheckinTime() : "");
          row.createCell(colNum++)
              .setCellValue(dto.getRegistrationNote() != null ? dto.getRegistrationNote() : "");
          row.createCell(colNum++)
              .setCellValue(dto.getRegistrationStatus() != null ? dto.getRegistrationStatus() : "");
          row.createCell(colNum++).setCellValue(dto.getStaffId() != null ? dto.getStaffId() : "");
          row.createCell(colNum++)
              .setCellValue(dto.getStaffName() != null ? dto.getStaffName() : "");
          row.createCell(colNum++)
              .setCellValue(Boolean.TRUE.equals(dto.getIsStoreManager()) ? "Quản Lý Sự Kiện" : "");
        }
