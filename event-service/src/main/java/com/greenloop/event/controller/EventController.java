...
public class EventController {
    ...
    public ResponseEntity<ApiResponseDTO<Page<EventResponse>>> getEventsByFilter(
        ...
        return ResponseEntity.ok(
                ApiResponseDTO.success("Lấy danh sách sự kiện cho người dùng thành công", events, HttpStatus.OK));
    }
    ...
    public ResponseEntity<ApiResponseDTO<List<EventStaffResponse>>> getStaffsByEventId(
        ...
        return ResponseEntity.ok(
                ApiResponseDTO.success("Lấy danh sách sự kiện được phân bổ cho nhân viên thành công", staffs, HttpStatus.OK));
    }
    ...
    public ResponseEntity<ApiResponseDTO<String>> registerToEvent(
        ...
        return ResponseEntity.ok(
                ApiResponseDTO.success("Khách hàng đã đăng ký thành công cho sự kiện", "OK", HttpStatus.OK));
    }
    ...
    public ResponseEntity<ApiResponseDTO<List<UserEventResponse>>> getMyEvents() {
        ...
        return ResponseEntity.ok(
                ApiResponseDTO.success("Lấy danh sách sự kiện khách hàng đăng ký thành công", events, HttpStatus.OK));
    }
    ...
    public ResponseEntity<ApiResponseDTO<UserEventDetailResponse>> getMyEventDetail(
        ...
        return ResponseEntity.ok(
                ApiResponseDTO.success("Lấy thông tin sự kiện chi tiết người dùng đăng ký thành công", detail, HttpStatus.OK));
    }
    ...
    public ResponseEntity<ApiResponseDTO<String>> updateRegistrationStatus(
        ...
        return ResponseEntity.ok(
                ApiResponseDTO.success("Cập nhật trạng thái người dùng đăng ký sự kiện thành công", "OK", HttpStatus.OK));
    }
    ...
    getRegistrationsByEvent(
        ...
        return ResponseEntity.ok(
                ApiResponseDTO.success(
                        "Lấy danh sách đăng ký sự kiện thành công.",
                        registrations,
                        HttpStatus.OK));
    }
    ...
    public ResponseEntity<ApiResponseDTO<List<EventStaffScheduleResponse>>> getStaffEventSchedule() {
        ...
        return ResponseEntity.ok(
                ApiResponseDTO.success("Lịch trình sự kiện của nhân viên đã được truy xuất thành công.",
                        schedules,
                        HttpStatus.OK));
    }
