...
public class DataInit implements CommandLineRunner {
    ...
    private void initializeEvents() {
        ...
        Event event1 = Event.builder()
                ...
                .description("Sự kiện thu gom quần áo, giày dép, túi xách cũ tại trung tâm thành phố. Mang theo quần áo không còn sử dụng để đổi lấy EcoPoint. Tất cả các loại quần áo đều được chấp nhận: áo, quần, váy, đầm, áo khoác, giày, dép, túi xách, phụ kiện. Quần áo sẽ được phân loại, làm sạch và tái chế thành sợi vải mới hoặc chế biến thành các sản phẩm thời trang tái chế. Mỗi kg quần áo được tích 50 EcoPoint.")
                ...
                .note("Quần áo cần giặt sạch, phơi khô trước khi mang đến. Sẽ có cân điện tử tại chỗ để đo khối lượng.")
                .build();
        event1.setCreatedBy(1L);
        event1.setUpdatedBy(1L);
        event1 = eventRepository.save(event1);

        addEventMedia(event1, List.of(
        ...
        Event event2 = Event.builder()
                ...
                .description("Chương trình thu gom quần áo cũ cuối tuần tại Quận Gò Vấp. Đổi quần áo cũ lấy EcoPoint để mua sắm các sản phẩm thời trang tái chế trên hệ thống. Chương trình chấp nhận tất cả các loại quần áo: quần áo trẻ em, người lớn, quần áo mùa đông, mùa hè, giày dép, túi xách. Các món đồ sẽ được cân, phân loại và xử lý theo quy trình tái chế chuẩn quốc tế. Tỉ lệ quy đổi: 1 kg = 50 EcoPoint.")
                ...
                .locationDetail("Nhà Văn hóa Quận Gò Vấp, số 315 Quang Trung, Phường 10, Quận Gò Vấp, TP.HCM")
                .latitude("10.8387")
                .longitude("106.6621")
                .status(EventStatus.UPCOMING)
                .note("Xe bus miễn phí từ Bến xe Miền Đông lúc 7h sáng. Mang theo túi đựng đồ riêng để tiện di chuyển.")
                .build();
        event2.setCreatedBy(1L);
        event2.setUpdatedBy(1L);
        event2 = eventRepository.save(event2);

        addEventMedia(event2, List.of(
        ...
        Event event3 = Event.builder()
                ...
                .description("Sự kiện thu gom quần áo cũ đã diễn ra thành công với lượng quần áo thu được 850 kg. Các món đồ đã được phân loại, xử lý và chuyển đến cơ sở tái chế. Tổng số người tham gia: 420 người. Tổng EcoPoint đã trao: 42,500 điểm. Đây là một trong những sự kiện thu gom thành công nhất trong tháng 11.")
                ...
                .locationDetail("Nhà Văn hóa Thanh Niên, số 4 Phạm Ngọc Thạch, Phường 6, Quận 3, TP.HCM")
                .latitude("10.7756")
                .longitude("106.6917")
        ...
        Event event4 = Event.builder()
                ...
                .description("Sự kiện thu gom quần áo cũ tại Quận 7 đã tạm hoãn do điều kiện thời tiết không thuận lợi. Chương trình sẽ được tổ chức lại vào cuối tháng này với địa điểm và thời gian mới. Thông tin cập nhật sẽ được thông báo qua email và ứng dụng. Xin lỗi vì sự bất tiện này.")
                ...
                .locationDetail("Trung tâm Văn hóa Quận 7, số 788 Nguyễn Văn Linh, Phường Tân Phú, Quận 7, TP.HCM")
                .latitude("10.7321")
                .longitude("106.7196")
        ...
        Event event5 = Event.builder()
                ...
                .description("Sự kiện thu gom quần áo cũ quy mô lớn nhất năm với mục tiêu thu gom 10 tấn quần áo trong 2 ngày. Địa điểm rộng rãi, nhiều điểm tiếp nhận. Có xe bus đưa đón miễn phí từ nhiều điểm trong thành phố. Tỉ lệ quy đổi đặc biệt: 1 kg = 100 EcoPoint (gấp đôi thông thường). Ngoài ra còn có các hoạt động trải nghiệm, trưng bày sản phẩm thời trang tái chế, tư vấn cách phân loại quần áo tại nhà. Dự kiến có hơn 5000 người tham gia.")
                ...
                .longitude("106.6800")
                .status(EventStatus.UPCOMING)
                .note("Sự kiện lớn nhất năm. Gấp đôi EcoPoint: 1 kg = 100 điểm. Đăng ký trước để được ưu tiên.")
                .build();
        event5.setCreatedBy(1L);
        event5.setUpdatedBy(1L);
        event5 = eventRepository.save(event5);

        addEventMedia(event5, List.of(
                "https://images.unsplash.com/photo-1489987707025-afc232f7ea0f",
                "https://images.unsplash.com/photo-1558769132-cb1aea2f14e4",
                "https://images.unsplash.com/photo-1445205170230-053b83016050"
        ));
