...
public class VoucherServiceImpl implements VoucherService {
    ...
    public Long createVoucherCampaign(CreateVoucherCampaignRequest request) {
        ...
        if (request.getVouchers() != null && !request.getVouchers().isEmpty()) {
            request.getVouchers().forEach(voucherRequest -> {
    ...
    public Long createVoucher(CreateVoucherRequest request) {
        ...
        VoucherCampaign voucherCampaign = voucherCampaignRepository.findById(request.getCampaignId())
    ...
    public void updateVoucherCampaign(CreateVoucherCampaignRequest request, Long campaignId) {
        VoucherCampaign voucherCampaign = voucherCampaignRepository.findById(campaignId)
                .orElseThrow(() -> new BusinessException(ErrorCode.VOUCHER_CAMPAIGN_NOT_FOUND));
        validateTimeFrame(request);
    ...
    public Page<VoucherResponse> getVouchersForAdmin(
        ...
        Specification<Voucher> spec = (root, query, cb) -> {
            ...
            if (minOrderValue != null) {
                predicates = cb.and(predicates, cb.greaterThanOrEqualTo(root.get("minOrderValue"), minOrderValue));
            }

            if (maxDiscount != null) {
                predicates = cb.and(predicates, cb.lessThanOrEqualTo(root.get("maxDiscount"), maxDiscount));
            }
