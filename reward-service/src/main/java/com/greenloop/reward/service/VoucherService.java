...
public interface VoucherService {
    ...
    Page<VoucherCampaignResponse> getVoucherCampaignsForCustomer(String name, LocalDateTime from, LocalDateTime to, int page, int size);

    Page<VoucherCampaignResponse> getVoucherCampaignsForAdmin(String name, LocalDateTime from, LocalDateTime to, int page, int size);
