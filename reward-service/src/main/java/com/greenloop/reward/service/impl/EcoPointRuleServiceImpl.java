...
public class EcoPointRuleServiceImpl implements EcoPointRuleService {
  ...
  @Override
  public EcoPointResponse getEcoPointInfo(EcoPointInfoRequest request) {
    String redisKey =
        "eco_point_rule_" + request.getEcoActionType() + "_" + request.getCategoryId();
    ...
    EcoPointRule rule =
        ecoPointRuleRepository
            .findByActionTypeAndCategoryId(request.getEcoActionType(), request.getCategoryId())
