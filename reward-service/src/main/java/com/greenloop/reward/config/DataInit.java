...
public class DataInit implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (countCampaign == 0) {
            ...
            List<VoucherCampaign> campaigns = List.of(
                    ...
                    createCampaign("Loyalty Rewards Campaign", "Special vouchers for loyal customers", 3)
            );
    ...
    private VoucherCampaign createCampaign(String name, String description, int monthOffset) {
        ...
        campaign.addVoucher(createVoucher("DISCOUNT10-" + monthOffset,
                "10% OFF", 100, new BigDecimal("0.10"),
                new BigDecimal("100000"), new BigDecimal("50000"),
                100, campaign));

        campaign.addVoucher(createVoucher("FREESHIP-" + monthOffset,
                "Free Shipping", 50, BigDecimal.ZERO,
                new BigDecimal("50000"), new BigDecimal("30000"),
                150, campaign));

        campaign.addVoucher(createVoucher("SAVE50K-" + monthOffset,
                "Save 50,000₫", 200, new BigDecimal("50000"),
