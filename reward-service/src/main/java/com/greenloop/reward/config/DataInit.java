...
public class DataInit implements CommandLineRunner {
    ...
    private void initEcoPointRules() {
        ...
        try {
            rules.forEach(rule -> {
                String cacheKey = rule.getCategoryId() != null
    ...
    private void initVoucherCampaigns() {
        ...
        log.info("Initialized {} voucher campaigns with {} total vouchers",
                campaigns.size(),
    ...
    private void initTestCustomers() {
        ...
        for (Long customerId : customerIds) {
            if (ecoPointUserRepository.findByUserId(customerId).isEmpty()) {
                EcoPointUser customer = EcoPointUser.builder()
                        .userId(customerId)
                        .totalPoints(10000)
    ...
    private VoucherCampaign createWelcomeCampaign() {
        ...
        campaign.addVoucher(createVoucher(
                "WELCOME10",
                "Giảm 10% Đơn Đầu",
