...
public class DashboardController {
    ...
    @Operation(summary = "Get eco point statistics", description = "Retrieves statistics related to eco points.")
    ...
    @GetMapping("/vouchers")
    @Operation(summary = "Get voucher statistics", description = "Retrieves statistics related to vouchers.")
    @PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_MANAGER')")
