...
public class VoucherController {
  ...
  //    @GetMapping("/admin")
  //    @Operation(summary = "Get vouchers for admins", description = "This endpoint retrieves
  // vouchers available to admins with optional filters.")
  //    @Tag(name = "Voucher Management", description = "APIs for managing vouchers and voucher
  // campaigns")
