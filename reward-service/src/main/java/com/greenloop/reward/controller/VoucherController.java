...
public class VoucherController {
    ...
    @Tag(
            name = "Voucher Management",
            description = "APIs for managing vouchers and voucher campaigns")
    public ResponseEntity<ApiResponseDTO<UserVoucherResponse>> validateVoucherForUser(@PathVariable("voucherUserId") Long voucherUserId) {
        ...
        return ResponseEntity.ok(
                ApiResponseDTO.<UserVoucherResponse>builder()
                        ...
                        .success(true)
                        .statusCode(HttpStatus.OK.value())
                        .message("Voucher validation completed successfully for user ID: " + voucherUserId)
                        .build());
    }
