...
public enum ErrorCode {
    ...
    VOUCHER_USER_NOT_FOUND(
            "VCH_009", "User voucher not found", HttpStatus.NOT_FOUND
    ),
    VOUCHER_USER_NOT_AVAILABLE(
            "VCH_010", "User voucher is not available for redemption", HttpStatus.BAD_REQUEST
    ),
    VOUCHER_USER_OUT_OF_QUANTITY(
            "VCH_011", "User voucher is out of quantity", HttpStatus.BAD_REQUEST
    ),
    VOUCHER_INACTIVE(
            "VCH_012", "Voucher is inactive", HttpStatus.BAD_REQUEST
    );
