...
public enum ErrorCode {
    ...
    ECO_POINT_RULE_NOT_FOUND(
            "ECO_003", "Không tìm thấy quy tắc eco point", HttpStatus.NOT_FOUND),

    INVALID_ECO_POINT_TRANSACTION(
            "ECO_004", "Giao dịch eco point không hợp lệ", HttpStatus.BAD_REQUEST),

    INVALID_TIME_FRAME(
            "ECO_005", "Khoảng thời gian không hợp lệ: ngày kết thúc trước ngày bắt đầu", HttpStatus.BAD_REQUEST),

    VOUCHER_CAMPAIGN_ID_REQUIRED(
            "VCH_001", "Yêu cầu cung cấp ID chiến dịch voucher", HttpStatus.BAD_REQUEST),

    VOUCHER_NOT_FOUND(
            "VCH_002", "Không tìm thấy voucher", HttpStatus.NOT_FOUND),

    INSUFFICIENT_VOUCHER_QUANTITY(
            "VCH_003", "Số lượng voucher không đủ", HttpStatus.BAD_REQUEST),

    VOUCHER_CAMPAIGN_NOT_FOUND(
            "VCH_004", "Không tìm thấy chiến dịch voucher", HttpStatus.NOT_FOUND),

    VOUCHER_IS_NOT_ACTIVE(
            "VCH_005", "Voucher không hoạt động", HttpStatus.BAD_REQUEST),

    VOUCHER_EXPIRED(
            "VCH_006", "Voucher đã hết hạn", HttpStatus.BAD_REQUEST),

    INSUFFICIENT_ECO_POINTS(
            "VCH_007", "Eco point không đủ để đổi voucher", HttpStatus.BAD_REQUEST),

    VOUCHER_OUT_OF_STOCK(
            "VCH_008", "Voucher đã hết số lượng", HttpStatus.BAD_REQUEST),
    ...
    VOUCHER_USER_NOT_FOUND(
            "VCH_009", "Không tìm thấy voucher người dùng", HttpStatus.NOT_FOUND),
    ...
    VOUCHER_INACTIVE(
            "VCH_012", "Voucher không hoạt động", HttpStatus.BAD_REQUEST);
